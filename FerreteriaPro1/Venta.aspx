<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Venta.aspx.cs" Inherits="FerreteriaPro1.Venta" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="input-group">
                <span class="input-group-addon">Ferreteria</span>
                <asp:DropDownList ID="cmbFerreteria" runat="server" CssClass="form-control" Width="100%" OnSelectedIndexChanged="cmbFerreteria_SelectedIndexChanged" AutoPostBack="true">
                </asp:DropDownList>
            </div>
        </div>
        <div class="col-md-6">
            <div class="input-group">
                ...
                <asp:DropDownList ID="cmbClientes" runat="server" CssClass="form-control" Width="100%">
                </asp:DropDownList>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body table-responsive">
                    <asp:GridView ID="dgvDetalleVenta" runat="server" class="table table-bordered table-condensed table-hover" AutoGenerateColumns="False" OnRowDeleting="dgvDetalleVenta_RowDeleting">
                        <Columns>
                            <asp:TemplateField HeaderText="#" Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="lblNumero" runat="server"
                                        Text="<%#(dgvDetalleVenta.PageSize * dgvDetalleVenta.PageIndex) + Container.DisplayIndex + 1%>">&nbsp; 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
                                    </asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="center" Width="5%" CssClass="hidden-xs" />
                                <HeaderStyle CssClass="hidden-xs info text-center" />
                            </asp:TemplateField>
                            <asp:BoundField AccessibleHeaderText="ID_FERRETERIA" DataField="ID_FERRETERIA" HeaderText="Ferreteria">
                                <ItemStyle CssClass="hidden" HorizontalAlign="Center" />
                                <HeaderStyle HorizontalAlign="Center" CssClass="info text-center hidden" />
                            </asp:BoundField>
                            <asp:BoundField AccessibleHeaderText="ID_CLIENTE" DataField="ID_CLIENTE" HeaderText="Cliente">
                                <ItemStyle CssClass="hidden" HorizontalAlign="Center" />
                                <HeaderStyle HorizontalAlign="Center" CssClass="info text-center hidden" />
                            </asp:BoundField>
